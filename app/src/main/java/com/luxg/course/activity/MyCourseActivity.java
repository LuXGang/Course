 ...
 */
public class MyCourseActivity extends BaseWiseActivity {
    ...
    private void findView() {
         ...
         */
        adapter = new SignUpCourseAdapter(list, getContext());//适配器跟选课的适配器一模一样
    ...
    private void getCourse(final int page) {
        ...
        if (NetWorkUtil.isNetworkAvailable(getContext())) {
            ...
            String url = Constant.URL + "findElectiveByStuId?studentId="+Constant.studentId+"&pageNum=" + pageString;
